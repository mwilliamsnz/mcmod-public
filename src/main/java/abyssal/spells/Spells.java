...
public class Spells {
    ...
    public static final Spell SUMMON_SKELETON = createSpell(new SkeletonSummonSpell(key("summon_skeleton"), new SpellFuelQuantity(SpellFuelTypes.FUEL_EVIL, 5)));
    public static final Spell ENCHANT = createSpell(new EnchantSpell(key("enchant"), new SpellFuelQuantity(SpellFuelTypes.FUEL_GENERIC, 20)));
