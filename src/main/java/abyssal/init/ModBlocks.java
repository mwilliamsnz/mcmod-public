...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> PRISM = registerWithDataLoot("prism", () -> new GlassBlock(BlockBehaviour.Properties.copy(Blocks.RED_STAINED_GLASS).lightLevel((state) -> {
        return 15;
    })));
