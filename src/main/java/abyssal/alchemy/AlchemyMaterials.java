...
//        Main.LOGGER.info(count + " at rank <= 2");
        ...
        AlchemyMaterial creeper_jelly = new AlchemyMaterial(() -> ModItems.CREEPER_JELLY.get(), DUST_COST);
        AlchemyMaterial saltpetre = new AlchemyMaterial(() -> ModItems.SALTPETRE.get(), DUST_COST);
        ...
        AlchemyMaterial sulfur = new AlchemyMaterial(() -> ModItems.SULFUR.get(), DUST_COST);
...
//        Main.LOGGER.info(count + " at rank <= 3");
        ...
        AlchemyMaterial poor_iron = new AlchemyMaterial(() -> ModItems.POOR_IRON.get(), NUGGET_COST*3, LOW_PURITY);
        ...
        AlchemyMaterial nether_brass_nugget = new AlchemyMaterial(() -> ModItems.NETHER_BRASS_NUGGET.get(), NUGGET_COST);
        AlchemyMaterial nether_brass_ingot = new AlchemyMaterial(() -> ModItems.NETHER_BRASS_INGOT.get(), STANDARD_COST);
        ...
        AlchemyMaterial pure_quartz = new AlchemyMaterial(() -> ModItems.PURE_QUARTZ.get(), DUST_COST, HIGH_PURITY, HIGH_PURITY_REQ);
        AlchemyMaterial prismatic_powder = new AlchemyMaterial(() -> ModItems.PRISMATIC_POWDER.get(), CHEAP_COST*2);
...
//        Main.LOGGER.info(count + " at rank <= 4");
        ...
        AlchemyMaterial silver_nugget = new AlchemyMaterial(() -> ModItems.SILVER_NUGGET.get(), STANDARD_COST, VERY_HIGH_PURITY, VERY_HIGH_PURITY_REQ);
        AlchemyMaterial silver_ingot = new AlchemyMaterial(() -> ModItems.SILVER_INGOT.get(), STANDARD_COST, VERY_HIGH_PURITY, VERY_HIGH_PURITY_REQ);
        AlchemyMaterial raw_silver = new AlchemyMaterial(() -> ModItems.RAW_SILVER.get(), STANDARD_COST, HIGH_PURITY, HIGH_PURITY_REQ);
        AlchemyMaterial alchemical_gold_ingot = new AlchemyMaterial(() -> ModItems.ALCHEMICAL_GOLD_INGOT.get(), STANDARD_COST, HIGH_PURITY, HIGH_PURITY_REQ);
        AlchemyMaterial alchemical_gold_nugget = new AlchemyMaterial(() -> ModItems.ALCHEMICAL_GOLD_NUGGET.get(), NUGGET_COST, HIGH_PURITY, HIGH_PURITY_REQ);
        AlchemyMaterial fools_gold = new AlchemyMaterial(() -> ModItems.FOOLS_GOLD.get(), STANDARD_COST);
        ...
        AlchemyMaterial uu_matter = new AlchemyMaterial(() -> ModItems.UU_MATTER.get(), STANDARD_COST);
...
//        Main.LOGGER.info(count + " at rank <= 5");
        ...
        AlchemyMaterial aether_wisp = new AlchemyMaterial(() -> ModItems.AETHER_WISP.get(), STANDARD_COST, VERY_HIGH_PURITY, VERY_HIGH_PURITY_REQ);
...
//        Main.LOGGER.info(count + " at rank <= 6");
        ...
        AlchemyMaterial warm_ingot = new AlchemyMaterial(() -> ModItems.WARM_INGOT.get(), STANDARD_COST*4);
        AlchemyMaterial plutonium_ingot = new AlchemyMaterial(() -> ModItems.PLUTONIUM_INGOT.get(), STANDARD_COST*4, VERY_HIGH_PURITY, VERY_HIGH_PURITY_REQ);
        ...
        AlchemyMaterial blankest_slate = new AlchemyMaterial(() -> ModItems.BLANKEST_SLATE.get(), STANDARD_COST, PERFECT_PURITY, PERFECT_PURITY_REQ);
        AlchemyMaterial inferno_essence = new AlchemyMaterial(() -> ModItems.INFERNO_ESSENCE.get(), STANDARD_COST, PERFECT_PURITY, PERFECT_PURITY_REQ);
