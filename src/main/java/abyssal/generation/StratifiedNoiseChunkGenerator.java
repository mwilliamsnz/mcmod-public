...
//
//public class StratifiedNoiseChunkGenerator extends ChunkGenerator {
//    public static final Codec<StratifiedNoiseChunkGenerator> CODEC = RecordCodecBuilder.create((p_188643_) -> {
...
//        })).apply(p_188643_, p_188643_.stable(StratifiedNoiseChunkGenerator::new));
//    });
...
//
//    public StratifiedNoiseChunkGenerator(Registry<NormalNoise.NoiseParameters> p_188609_, BiomeSource p_188610_, long p_188611_, Supplier<NoiseGeneratorSettings> p_188612_) {
//        this(p_188609_, p_188610_, p_188610_, p_188611_, p_188612_);
//    }
//
//    private StratifiedNoiseChunkGenerator(Registry<NormalNoise.NoiseParameters> p_188614_, BiomeSource p_188615_, BiomeSource p_188616_, long p_188617_, Supplier<NoiseGeneratorSettings> p_188618_) {
...
//            return new ModBeardifier(p_197002_, p_197003_);
...
//        NoiseChunk noisechunk = NoiseChunk.forColumn(k1, l1, p_158418_, p_158419_, this.sampler, this.settings.get(), this.globalFluidPicker);
...
//        NoiseChunk noisechunk = p_188633_.getOrCreateNoiseChunk(this.sampler, () -> {
...
//        NoiseGeneratorSettings noisegeneratorsettings = this.settings.get();
//        NoiseChunk noisechunk = p_188665_.getOrCreateNoiseChunk(this.sampler, () -> {
