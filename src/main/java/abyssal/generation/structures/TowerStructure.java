package abyssal.generation.structures;//package cornmod.generation.structures;
//
...
//
//public class TowerStructure extends StructureFeature<NoneFeatureConfiguration> {
//    public TowerStructure(Codec<NoneFeatureConfiguration> codec) {
//        super(codec);
//    }
//
//    /**
...
//     */
//    @Override
//    public StructureStart<NoneFeatureConfiguration> getStartFactory() {
...
//                            .get(new ResourceLocation(Main.MOD_ID, "tower_start")),
//
...
//            Main.LOGGER.log(Level.DEBUG, "Tower at " + this.pieces.get(0).getBoundingBox().getCenter());
//        }
//    }
//}
