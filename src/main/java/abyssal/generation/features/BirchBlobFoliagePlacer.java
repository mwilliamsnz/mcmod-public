...
public class BirchBlobFoliagePlacer  extends FoliagePlacer {
    public static final Codec<BirchBlobFoliagePlacer> CODEC = RecordCodecBuilder.create(instance -> blobParts(instance).apply(instance, BirchBlobFoliagePlacer::new));
