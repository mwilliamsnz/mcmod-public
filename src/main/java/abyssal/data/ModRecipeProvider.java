...
//        armour(recipeOutput, Items.WHITE_WOOL, Items.LEATHER_HELMET, ModItems.LEATHER_CHESTPLATE.get(), ModItems.LEATHER_LEGGINGS.get(), ModItems.LEATHER_BOOTS.get());
    ...
    private void makeCurios(RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.TOXIC_TOTEM.get())
                ...
                .unlockedBy("has_item", InventoryChangeTrigger.TriggerInstance.hasItems(Gems.gem(Gems.GemSize.SMALL, Gems.GemType.ONYX)))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.RAGE_TOTEM.get())
                ...
                .unlockedBy("has_item", InventoryChangeTrigger.TriggerInstance.hasItems(Gems.gem(Gems.GemSize.SMALL, Gems.GemType.GARNET)))
    ...
    private void makeSpellItems(RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.AMP_BOOKSHELF.get())
                .pattern("aaa")
                .pattern("scs")
                .pattern("aaa")
                ...
                .unlockedBy("has_item", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.AMP_TOME.get()))
                .save(recipeOutput, new ResourceLocation(Main.MOD_ID, "amplifying_bookshelf"));
