...
public class ModRecipeProvider extends RecipeProvider {
    ...
    private void makeTools() {
        ...
        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.COMBAT, ModItems.SPIRIT_VISAGE.get())
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.COMBAT, ModItems.THORNMAIL.get())
                .pattern("s s")
                .pattern("ici")
                .pattern("srs")
...
//        armour(Items.WHITE_WOOL, Items.LEATHER_HELMET, ModItems.LEATHER_CHESTPLATE.get(), ModItems.LEATHER_LEGGINGS.get(), ModItems.LEATHER_BOOTS.get());
    ...
    private void makeCurios() {
        ...
        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.COMBAT, ModItems.GLOWING_CARD.get())
                .pattern(" s ")
                .pattern("gng")
                .pattern("did")
