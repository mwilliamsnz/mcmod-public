...
public class ClientCoinPurseTooltip implements ClientTooltipComponent {
    ...
    private static final Component BUNDLE_EMPTY_DESCRIPTION = Component.translatable("item.abyssal.coin_purse.empty.description");
    ...
    private static int getContentXOffset(int width) {
        return (width - 96) / 2;
    }
