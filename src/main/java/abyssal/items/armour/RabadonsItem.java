...
public class RabadonsItem extends ModArmourItem {
    ...
    public RabadonsItem(Type slot, Properties properties) {
        ...
        builder.put(ModAttributes.ABILITY_POWER.get(), new AttributeModifier(uuid, "Ability power", 140, AttributeModifier.Operation.ADDITION));
        builder.put(ModAttributes.ABILITY_POWER.get(), new AttributeModifier(uuid2, "Ability power multiplier", 0.35, AttributeModifier.Operation.MULTIPLY_BASE));
